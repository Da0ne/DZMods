...
Vanilla++ aims to extend the Vanilla experience by implementing features and tools that help serverowners to get the maximum out of ther server and run it their way.
...
- If you are a player and want to play on Vanilla++ servers, please subscribe to [our steam workshop release](https://steamcommunity.com/sharedfiles/filedetails/?id=1578593068). It requires [RPCFramework](https://steamcommunity.com/workshop/filedetails/?id=1559212036) so if it does not already download automatically, subscribe to that aswell.
...
## Changelogs
#### December 1st 2018
Version 0.4 is FINALLY HERE! 
- Added client support through Steam Workshop.

## Credits

- @Sen ( @zalexki zalexki ) from DayZModders Discord Server for the KillScore system https://github.com/zalexki
- @Slluxx for rewriting this readme
